...
gulp.task('wct:livereload', function() {  
  var child = child_process.exec('./node_modules/livereloadx/bin/livereloadx.js app/test/');
...
gulp.task('wct:start', function() {  
  var child = child_process.exec('./node_modules/web-component-tester/bin/wct -p');
  child.stdout.on('data', function(data) {
    console.log(data.replace(/[\n\r]+/g, ''));
  });
});
